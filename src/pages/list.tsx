...
import ItemDetails from "@/pages/detail"
...
export default function ItemList() {
  ...
  const handleMarkAsDone = (item: Item, e: React.MouseEvent) => {
    e.stopPropagation()
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto px-4 pb-6">
            ...
            <div className="flex gap-3">
              ...
              <div className="flex border-2 border-gray-200 rounded-xl overflow-hidden">
                <Button
                  ...
                  } ${isMobile && viewMode === "grid" ? "hidden" : "flex"}`}
                >
      ...
      {viewMode === "grid" ? (
            ...
            >
              ...
              <CardContent className="p-6">
                ...
                <Button
                  ...
                  className={`w-full rounded-xl font-medium transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] ${
                    item.status === "Active"
        ...
        <div className="space-y-4">
          {paginatedItems.map((item: Item) => (
            <Card
              key={item.id}
              className="bg-white shadow-lg border-0 rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-xl cursor-pointer"
              onClick={() => handleItemClick(item)}
            >
              <CardContent className="p-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      ...
                      <Button
                        ...
                        disabled={updateMutation.isPending}
                        variant={item.status === "Active" ? "default" : "outline"}
                        className={`w-full md:w-auto rounded-xl font-medium transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] ${
                          item.status === "Active"
                            ? "bg-gray-900 hover:bg-gray-800 text-white"
                            : "border-2 border-gray-200 hover:border-gray-400 text-gray-700 hover:text-gray-900"
                        }`}
                ...
                {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                  <Button
                    ...
                    className={`rounded-xl w-10 h-10 ${
                      currentPage === page ? "bg-gray-900 text-white" : "border-2 border-gray-200 hover:border-gray-400"
                    }`}
                  >
                    {page}
                  </Button>
      ...
      {/* Item Details Modal */}
      <ItemDetails item={selectedItem} isOpen={isDetailsOpen} onClose={handleCloseDetails} />
    </div>
  )
}
